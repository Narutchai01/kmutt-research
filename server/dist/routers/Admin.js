...
const CardCounter_1 = require("../controller/admin/Chart/CardCounter");
...
router.get("/getChartCard", auth_1.auth, CardCounter_1.cardCounter);
router.get("/getChartLine", auth_1.auth, ChartLine_1.ChartLine);
router.get("/getChartDoughnut", auth_1.auth, ChartDoughnut_1.ChartDoughnut);
router.get("/getChartBar", auth_1.auth, ChartBar_1.ChartBar);
